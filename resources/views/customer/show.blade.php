                ...
                <div class="px-4 pt-0 pb-4 cover">
                    <div class="media align-items-end profile-head d-flex">
                        <div class="profile mr-3">
                            <img src="{{ asset($customer->image ?? 'defaults/avatar.png') }}"
                                alt="{{ $customer->first_name }} {{ $customer->last_name }}" width="130" height="130"
                                class="rounded-circle border border-light shadow-sm object-fit-cover"
                    ...
                    <div class="p-4 rounded shadow-sm bg-light">
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    <td style="width: 250px;">Birth Place</td>
